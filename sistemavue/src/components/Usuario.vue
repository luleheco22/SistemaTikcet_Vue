  ...
  export default {
    data: () => ({
      ...
      headers: [
            { text: 'Opciones', value: 'opciones', sortable: false },
                ...
                nombre:'',
                rol:'',
                roles: ['Administrador','Gerente','Analista','Cliente'],
                tipo_documento:'',
       ...
       async guardar(){
        try {
            ...
            if (this.editedIndex>-1) {
                //Editar
                  await  axios.put('usuario/update',{
                    '_id':this._id,
                        'rol':this.rol,
                        'nombre':this.nombre,
    ...
    async activar(){
        try {
            ...
            let header={'Token':this.$store.state.token}
              let configuracion={headers:header}
             await  axios.put('usuario/activate',{
                    '_id':this.adId
              },configuracion)
              me.adModal=0
              me.adAccion=0
    ...
    async desactivar(){
        try {
            ...
            let header={'Token':this.$store.state.token}
              let configuracion={headers:header}
             await  axios.put('usuario/desactivate',{
                    '_id':this.adId
              },configuracion)
              me.adModal=0
              me.adAccion=0
